...
const URI = `${config.app_uri}:${config.app_port}`
class MakeDataControler {
  ...
  async extradata(req: Request, res: Response){
    const rpta = {};
    rpta['next'] = `${URI}/make/presentacion`; //'http://192.168.100.150:4444/make/presentacion';
  ...
  async presentacion(req: Request, res: Response){
    const rpta = {};
    rpta['next'] = `${URI}/make/costo`; //'http://192.168.100.150:4444/make/costo';
  ...
  async costo(req: Request, res: Response){
    const rpta = {};
    rpta['next'] = `${URI}/make/precio`; //'http://192.168.100.150:4444/make/precio';
    try {
      const _art = await _presentacion.find();
      rpta['src'] = _art;
      rpta['rslt'] = [];
  ...
  async precio(req: Request, res: Response){
    const rpta = {};
    rpta['next'] = `${URI}/make/productoname`; //'http://192.168.100.150:4444/make/productoname';
    try {
      const _art = await _presentacion.find();
      rpta['src'] = _art;
      rpta['rslt'] = [];
