...
class FabricanteControlers {
  ...
  async add(req: Request, res: Response){
    ...
    try {
      ...
      ret.value instanceof fabricantes; // true
  ...
  async put(req: Request, res: Response){
    ...
    let ret = {};
    try {
      ret['data'] = await fabricantes.findByIdAndUpdate(params._id, params);
...
export const FabricanteCtrl = new FabricanteControlers();